...
export async function createQuestion(
  ...
  try {
    ...
    // Log the interaction directly after committing the transaction
...
export async function getRecommendedQuestions({
  ...
  // console.log("recommendedQuery", recommendedQuery);
...
export async function deleteQuestion(
  ...
  try {
    ...
    // Commit the transaction before logging the interaction
    await session.commitTransaction();
    session.endSession();

    // Log the interaction directly
    await createInteraction({
      action: "delete",
      actionId: questionId,
      actionTarget: "question",
